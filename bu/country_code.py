...
if len(sys.argv)>=2 :
    ...
    name="us"
name=name.upper()
print("Selected Country Name",name)
if name in arr:
    stri=arr[name]
    print("Country code",stri)
    with fileinput.FileInput('/etc/tor/torrc',inplace='true', backup='.bak') as file:
        for line in file:
            lc=line.split()
            if len(lc)>0 and lc[0]=="ExitNodes":
                print('ExitNodes '+stri)
            else:
                print(line,end='')

    print("Country code changed")
else :
    print("Invalid Input")
